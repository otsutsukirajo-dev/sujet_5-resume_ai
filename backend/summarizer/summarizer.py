...
DEFAULT_MODEL_NAME = "plguillou/t5-base-fr-sum-cnndm"
MODEL_PROMPT_PREFIX = "summarize: "  # requis par les modeles T5. Mettre "" pour un modele qui n'en a pas besoin (ex: bart-large-cnn).
